    ...
    <SideBarLayout>
        <template #header>
            <div class="flex justify-between">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Suppliers Information</h2>
                ...
                <div>
                    <Link v-if="$page.props.auth.permissions.includes('manage-suppliers')" class="button1 mb-2 py-2 px-3 bg-blue-300 shadow border-gray-300 border hover:bg-blue-400 rounded mr-3" as="button" href="/suppliers/create">Create Supplier</Link>
                ...
                <div class="bg-white shadow-md rounded my-3">
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            <tr class="border-b border-gray-200 hover:bg-gray-50" v-for="sup in suppliers.data" :key="sup.id">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <Link :href="'suppliers/edit/'+sup.id" class="btn" v-if="$page.props.auth.permissions.includes('manage-suppliers')">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <a href="#" @click="remove(sup)" class="btn" title="Delete Supplier" v-if="$page.props.auth.permissions.includes('manage-suppliers')">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
