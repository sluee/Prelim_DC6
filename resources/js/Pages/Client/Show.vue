    ...
    <SideBarLayout>
        <template #header>
            <div class="flex">
                ...
                <Link class="button1 mb-2 py-2 px-3 bg-gray-300 shadow border-gray-300 border hover:bg-gray-400 rounded mr-3" as="button" :href="'/clients/'">Back</Link>
            </div>
        </template>
                ...
                <div class="bg-white  shadow-lg sm:rounded-lg">
                    <div class="p-6 text-gray-900 flex">
                        ...
                        <div class="flex-1 ml-4 bg-">
                            ...
                            <hr>
                            <div class="mt-2" > Name: {{ client.last_name }} , {{ client.first_name }}</div>
                            <div class="mt-2">$ {{ client.phone }}</div>
                            <div class="py-4">{{ client.phone}} </div>
